INSERT INTO tickets (
    ...
    (3, 'Overheating problem', 'Customers computer is overheating and shutting down frequently.', false, 'unassigned', now(), now()),
    ...
    (5, 'Blue screen error', 'Customers computer is showing a blue screen error frequently.', false, 'unassigned', now(), now()),
    (5, 'Memory upgrade', 'Customer requested an upgrade to their computer RAM.', false, 'unassigned', now(), now());